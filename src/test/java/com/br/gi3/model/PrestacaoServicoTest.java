...
class PrestacaoServicoTest {
    ...
    void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(PrestacaoServico.class);

        PrestacaoServico prestacaoServico1 = new PrestacaoServico();
        PrestacaoServico prestacaoServico2 = new PrestacaoServico();
