...
class RepasseBancorbrasTest {
    ...
    void equalsVerifier() throws Exception {
        TestUtil.equalsVerifier(RepasseBancorbras.class);

        RepasseBancorbras repasseBancorbras1 = new RepasseBancorbras();
        RepasseBancorbras repasseBancorbras2 = new RepasseBancorbras();
